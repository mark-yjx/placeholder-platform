...
- administrators should no longer use the extension
- the extension should eventually reject admin-role logins
...
- student client: login, problems, starter files, submissions, own-submission review, and future local public-test execution
- admin client: admin login, problem CRUD, public/hidden test editing, submission inspection, hidden failure-detail inspection, future user management, future 2FA
...
- explicit rejection of admin-role logins so the extension remains a student-only client
